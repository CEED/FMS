...
TEST(Fms, MetaDataCompare) {
  ...
  // Compare integer mds
  FmsInt *data0 = NULL;
  ASSERT_EQ(FmsMetaDataSetIntegers(mds[0], "Ints", FMS_INT_TYPE, 3,
                                   (void**)&data0), 0);
  ASSERT_TRUE(data0);
  ...
  FmsInt *data1 = NULL;
  ASSERT_EQ(FmsMetaDataSetIntegers(mds[1], "Ints", FMS_INT_TYPE, 3,
                                   (void**)&data1), 0);
  ...
  ASSERT_EQ(FmsMetaDataSetIntegers(mds[1], "Ints1", FMS_INT_TYPE, 3,
                                   (void**)&data1), 0);
  ASSERT_TRUE(data1);
  data1[0] = 3; data1[1] = 5; data1[2] = 1;
  ...
  ASSERT_EQ(FmsMetaDataSetIntegers(mds[1], "Ints", FMS_INT_TYPE, 4,
                                   (void**)&data1), 0);
  ASSERT_TRUE(data1);
  ...
  ASSERT_EQ(FmsMetaDataSetIntegers(mds[1], "Ints", FMS_UINT16, 3,
                                   (void**)&data11), 0);
  ASSERT_TRUE(data11);
  ...
  // Compare scalar mds
  double *data2 = NULL;
  ASSERT_EQ(FmsMetaDataSetScalars(mds[2], "Ints", FMS_DOUBLE, 4, (void**)&data2),
            0);
  ASSERT_TRUE(data2);
  ...
  ASSERT_EQ(FmsMetaDataSetScalars(mds[2], "Scalars", FMS_DOUBLE, 4,
                                  (void**)&data2), 0);
  ASSERT_TRUE(data2);
  data2[0] = 3.; data2[1] = 5.; data2[2] = 1.; data2[3] = 10.;
  // Compare different contents
  double *data3 = NULL;
  ASSERT_EQ(FmsMetaDataSetScalars(mds[3], "Scalars", FMS_DOUBLE, 4,
                                  (void**)&data3), 0);
  ASSERT_TRUE(data3);
  ...
  // Compare different sizes
  ASSERT_EQ(FmsMetaDataSetScalars(mds[3], "Scalars", FMS_DOUBLE, 3,
                                  (void**)&data3), 0);
  ASSERT_TRUE(data3);
  ...
  float *data31 = NULL;
  ASSERT_EQ(FmsMetaDataSetScalars(mds[3], "Scalars", FMS_FLOAT, 4,
                                  (void**)&data31), 0);
  ASSERT_TRUE(data31);
  ...
  ASSERT_TRUE(data6);
  int32_t *data61 = NULL;
  ASSERT_EQ(FmsMetaDataSetIntegers(data6[0], "Int", FMS_INT32, 1,
                                   (void**)&data61), 0);
  ASSERT_TRUE(data61);
  data61[0] = 7;
  double *data62 = NULL;
  ASSERT_EQ(FmsMetaDataSetScalars(data6[1], "Scalars", FMS_DOUBLE, 3,
                                  (void**)&data62), 0);
  ASSERT_TRUE(data62);
  ...
  ASSERT_TRUE(data7);
  int32_t *data71 = NULL;
  ASSERT_EQ(FmsMetaDataSetIntegers(data7[0], "Int", FMS_INT32, 1,
                                   (void**)&data71), 0);
  ASSERT_TRUE(data71);
  data71[0] = 7;
  double *data72 = NULL;
  ASSERT_EQ(FmsMetaDataSetScalars(data7[1], "Scalars", FMS_DOUBLE, 3,
                                  (void**)&data72), 0);
  ASSERT_TRUE(data72);
  ...
  ASSERT_EQ(FmsMetaDataSetMetaData(mds[7], "MetaDatas", 2, &data7), 0);
  ASSERT_TRUE(data7);
  ASSERT_EQ(FmsMetaDataSetScalars(data7[0], "Scalars", FMS_DOUBLE, 3,
                                  (void**)&data72), 0);
  ASSERT_TRUE(data72);
  data72[0] = 3.; data72[1] = 5.; data72[2] = 1.;
  ASSERT_EQ(FmsMetaDataSetIntegers(data7[1], "Int", FMS_INT32, 1,
                                   (void**)&data71), 0);
  ASSERT_TRUE(data71);
  data71[0] = 7;
  EXPECT_NE(FmsMetaDataCompare(mds[6], mds[7]), 0);
...
TEST(Fms, FieldDescriptorCompare) {
  ...
  for(int i = 0; i < 7; i++) {
    ...
    ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdi, FMS_CONTINUOUS,
              static_cast<FmsBasisType>(i), 10), 0);
    for(int j = 0; j < 7; j++) {
      ...
      ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdj, FMS_CONTINUOUS,
                static_cast<FmsBasisType>(j), 10), 0);
      if(i == j) {
  ...
  for(int i = 0; i < 5; i++) {
    ...
    ASSERT_TRUE(fdi);
    ASSERT_EQ(FmsFieldDescriptorSetComponent(fdi, volume), 0);
    ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdi, static_cast<FmsFieldType>(i),
              FMS_NODAL_GAUSS_CLOSED, 10), 0);
    for(int j = 0; j < 5; j++) {
      if(static_cast<FmsFieldType>(j) == FMS_HCURL) continue;
      FmsFieldDescriptor fdj = NULL;
      ASSERT_EQ(FmsDataCollectionAddFieldDescriptor(dc, "FD", &fdj), 0);
      ASSERT_EQ(FmsFieldDescriptorSetComponent(fdj, volume), 0);
      ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdj, static_cast<FmsFieldType>(j),
                FMS_NODAL_GAUSS_CLOSED, 10), 0);
      ASSERT_NE(fdi, fdj);
      if(i == j) {
        EXPECT_EQ(FmsFieldDescriptorCompare(fdi, fdj), 0)
  ...
  ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdv, FMS_CONTINUOUS,
            FMS_NODAL_GAUSS_CLOSED, 3), 0);
  ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(fdb, FMS_CONTINUOUS,
            FMS_NODAL_GAUSS_CLOSED, 3), 0);
  ASSERT_NE(fdv, fdb);
  ...
  ASSERT_EQ(FmsFieldDescriptorSetFixedOrder(diff_name, FMS_CONTINUOUS,
            FMS_NODAL_GAUSS_CLOSED, 3), 0);
